...
const Card: FC<{
  ...
  >
    ...
    <Text mb="1.5rem" fontSize="0.875rem" lineHeight="1.3125rem" color={'#52557A'} fontWeight="400">
      ...
      <UnorderedList styleType="disc" stylePosition="inside">
        {abilities.map((e, i) => (
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unlock the Power of Streamlined Dining with Restaurant Booking Engine - Your Ultimate Solution for Table Reservations and Menu Management."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyZXN0YXVyYW50fGVufDB8fHx8MTY5MzIxMjkzOXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock the Power of Streamlined Dining with Restaurant Booking Engine - Your Ultimate Solution for Table Reservations and Menu Management.`}
            </Text>
            <Box
